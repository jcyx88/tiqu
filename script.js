    ...
    welcomeMessages.forEach(function(message) {
        ...
        messageDiv.onclick = function() {
            ...
            if (message === '请点击第一句获取游戏。') {
                ...
                replyMessage.innerHTML = '<img src="bot-avatar.jpg" alt="Avatar"/><p>提取码咨询Q群客服。</p>''<img src="bot-avatar.jpg" alt="Avatar"/><p>提取码咨询。<。<'<img s            chat.scrollTop = chat.scrollHeight;
        };
