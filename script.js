    ...
    welcomeMessages.forEach(function(message) {
        ...
        messageDiv.onclick = function() {
            ...
            if (message === '请点击第一句获取游戏。') {
                replyMessage.innerHTML = '<img src="bot-avatar.jpg" alt="Avatar"/><p>我用夸克网盘给你分享了「游戏获取」，点击链接或复制整段内容，打开「夸克APP」即可获取。/~b89f3AJLjQ~:/链接：https://pan.quark.cn/s/e307f3a9a980</p>';
            } else if (message === '请点击第二句获取安卓和电脑教程。') {
                replyMessage.innerHTML = '<img src="bot-avatar.jpg" alt="Avatar"/><p>我用夸克网盘给你分享了「安卓和电脑教程」，点击链接或复制整段内容，打开「夸克APP」即可获取。/~88393AJLXo~:/链接：https://pan.quark.cn/s/c1a0777c952d</p>';
            } else if (message === '请点击第三句获取ios教程。') {
                replyMessage.innerHTML = '<img src="bot-avatar.jpg" alt="Avatar"/><p>我用夸克网盘给你分享了「ios教程」，点击链接或复制整段内容，打开「夸克APP」即可获取。/~aaee3AJLLa~:/链接：https://pan.quark.cn/s/4d0f36a2fbf7</p>';
            } else {
